// ======================================================================
// \title  ExamplesDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef EXAMPLESDEPLOYMENT_EXAMPLESDEPLOYMENTTOPOLOGY_HPP
#define EXAMPLESDEPLOYMENT_EXAMPLESDEPLOYMENTTOPOLOGY_HPP
// Included for access to ExamplesDeployment::TopologyState and ExamplesDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ExamplesDeployment/Top/ExamplesDeploymentTopologyDefs.hpp>

// Remove unnecessary ExamplesDeployment:: qualifications
 ...
 * ExamplesDeployment::TopologyState see: ExamplesDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ExamplesDeployment::TopologyState see: ExamplesDeploymentTopologyDefs.hpp.
 *
